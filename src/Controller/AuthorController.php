...
final class AuthorController extends AbstractController
{
    ...
    public function listAuthors(){
        $var = "3A28";
        return $this->render("author/list.html.twig",['x'=>$var]);
    }*/
    #[Route('/list', name: 'list_author')]
    public function listAuthors(){
        $var = "3A28";
    ...
    #[Route('/listEmails', name: 'list_emails')]
    public function listEmails(AuthorRepository $repo)
    {
        $emails = $repo->listAuthorByEmail();

        return $this->render('author/list_emails.html.twig', [
            'emails' => $emails,
        ]);
    }
